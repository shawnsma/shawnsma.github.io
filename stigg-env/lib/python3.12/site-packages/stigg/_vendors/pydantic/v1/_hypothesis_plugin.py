...
from ... import pydantic
from ...pydantic import color as ___vendorize__0
pydantic.color = ___vendorize__0
from ... import pydantic
from ...pydantic import types as ___vendorize__0
pydantic.types = ___vendorize__0
